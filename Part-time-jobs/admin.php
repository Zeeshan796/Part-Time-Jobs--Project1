...
<div id="intro" class="view">
    ...
    <div class="row">
        <div class="col-4 offset-4">
        	<br>
            <p style="font-size: 30px; color: gray; border-radius: 20px;" class="text-center" ><strong>Admin Login</strong></p>
            <form class="text-center" method="POST" action="connectadmin.php">
                <br>
                
                <input type="text" name="email" required placeholder="&#xf0e0 Enter email" style="border: none;outline: none; font-size: 20px" class="form-control fa fa-envelope">
                <hr>
                <br>
                
                <input type="password" name="password" required placeholder="&#xf023 Enter password" style="border: none;outline: none; font-size: 20px" class="form-control fa fa-lock">
                
                <!--<a href="" type="">Forgot password?</a>-->
                <hr>
		
                <div>
                    <button type="submit" value="Submit" name="login" class="btn btn-lg btn-primary">Login</button>
...
#intro{
	width: 100%;
	height: 100vh;
	background-image: url(bckpic.jpg);
